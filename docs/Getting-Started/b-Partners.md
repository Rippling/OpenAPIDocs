...
Here is a video of the partner application installation flow. Please note, in this case the application requires the customer subdomain, but this is not a requirement.
