...
*Additionally, you may notice that certain fields are not marked as required the Rippling API documentation. The information returned via the requests will be determined by the level of scopes your access token or API key is entitled to access.* 
